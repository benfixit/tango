...
class Paginator
{
    ...
    private function paginate($page = 1,$items_total = 0)
    {
        ...
        {
            $this->return = ($this->current_page > 1 && $items_total >= 10) ? "<li><a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$prev_page\">&laquo; Previous</a></li> ":"<li><span class=\"inactive\" href=\"#\">&laquo; Previous</span></li> ";
            ...
            for($i=1;$i<=$this->num_pages;$i++)
            {
                ...
                {
                    $this->data['pages'][] =  $i;
                    $this->return .= ($i == $this->current_page) ? "<li><a title=\"Go to page $i of $this->num_pages\" class=\"current\" href=\"#\">$i</a></li> ":"<li><a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=\"$_SERVER[PHP_SELF]?page=$i\">$i</a></li> ";
                }
            ...
            $this->return .= (($this->current_page < $this->num_pages && $items_total >= 10) And ($page != 'All') And $this->current_page > 0) ? "<li><a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page\">Next &raquo;</a></li>\n":"<li><span class=\"inactive\" href=\"#\">&raquo; Next</span></li>\n";
        ...
        else
        {
            ...
            {
                $this->data['pages'][] = $i; 
                $this->return .= ($i == $this->current_page) ? "<li><a class=\"current\" href=\"#\">$i</a></li> ":"<li><a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$i\">$i</a></li> ";
            }
        }
    }
    /**
